...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const map_1 = __webpack_require__(1);
	const ping_1 = __webpack_require__(8);
	__webpack_require__(3);
	map_1.default();
	ping_1.default.init();
	document.getElementById("ping").onclick = ping_1.default.send;
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	const loc = __webpack_require__(2);
	function initMap() {
	...
	function addMarker(location) {
	    if (exports.map === undefined) {
	        ...
	        exports.map.setCenter(position);
	    }
	}
	...
	(function (Ping) {
	    ...
	    function init() {
	        ...
	        socket.onmessage = event => {
	            let ping = JSON.parse(event.data);
